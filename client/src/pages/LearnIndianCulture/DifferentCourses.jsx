...
const DifferentCourses = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-5 ">
      <h1 className="px-5 py-2   rounded-xl hollowBorder text-4xl font-extrabold font-playfair">
        {title}
      </h1>
      ...
      <div className="relative w-full z-40 ">
        ...
        >
          {courses.map((course, idx) => (
            <div
              key={idx}
              className="min-w-[300px] lg:min-w-[435px] p-5 rounded-lg flex flex-col items-center shadow-lg shadow-gray-400 gap-5 "
            >
