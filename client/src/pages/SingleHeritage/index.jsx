      ...
      >
        ...
        <div className=" flex flex-col gap-20 items-center justify-center  px-10 py-32  h-screen   text-dark_primary_text">
          ...
          <p className="text-lg ">
            ...
            dolor delectus minus eligendi, eaque quam quidem impedit asperiores.
            Fugit voluptas consequuntur repudiandae laudantium? Lorem ipsum
            dolor sit amet, consectetur adipisicing elit. Culpa non assumenda
            quos dolorem modi dolorum maxime quae exercitationem, eligendi eius,
            aliquid quia eum. Dicta doloribus id fugit cupiditate, vel ipsa.
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione
            commodi ad labore asperiores voluptatem, illum nostrum reprehenderit
            repudiandae expedita ducimus magnam, similique architecto odio,
            suscipit quibusdam modi nobis quae laboriosam.
          </p>
        </div>
        ...
        <div className="bg-background1 dark:bg-dark_background1 py-4 px-10 text-lg flex flex-col items-center justify-center w-full h-full">
          <div className="flex flex-col gap-1">
            ...
            <p>
              ...
              enim, fugiat, maiores dolor magni saepe quos id neque voluptas?
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Aspernatur unde aliquid mollitia similique voluptatibus voluptatem
              sequi dolores id dolorum labore a sunt hic, blanditiis in velit!
              Totam quia itaque quam. Lorem, ipsum dolor sit amet consectetur
              adipisicing elit. Temporibus dolorum animi veritatis adipisci
              saepe qui possimus eligendi atque ab iste! Facere corporis ipsa
              quia earum accusantium officiis maiores, mollitia excepturi!
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Reiciendis eum neque eius sed veritatis libero velit placeat
              perferendis minima accusamus, iure, debitis ducimus est sapiente
              molestias rem omnis enim ad. Lorem ipsum dolor sit amet
              ...
              sequi dolores id dolorum labore a sunt hic, blanditiis in velit!
              Totam quia itaque quam. Lorem, ipsum dolor sit amet consectetur
              adipisicing elit. Temporibus dolorum
            </p>
            <h1 className=" font-semibold font-montserrat text-2xl">
              Heading 2
            </h1>
        ...
        <div className="bg-background1 dark:bg-dark_background1 py-4 px-10 pt-4  flex flex-col gap-10 items-center justify-center w-full h-full">
          ...
          <div className="grid grid-cols-3  items-center justify-center text-xl gap-5">
            ...
            <div className="flex items-center justify-center gap-1 border-2 p-2 rounded-xl">
              ...
              <p>
                {" "}
                <b className=" text-highlight_hover"> Women's Helpline: </b>+91
                0000000000
              </p>
            </div>
            <div className="flex items-center justify-center gap-1 border-2 p-2 rounded-xl">
            ...
            <div className="flex items-center justify-center gap-1 border-2 p-2 rounded-xl">
              <MdLocalPolice className=" text-highlight_hover" />
              <p>
                {" "}
