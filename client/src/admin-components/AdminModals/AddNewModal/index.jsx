...
const AddNewModal = ({ setModalOpen, handleApply, children }) => {
  return (
    <div className="fixed inset-0 bg-background1 dark:bg-dark_background1 text-primary_text dark:text-dark_primary_text bg-opacity-50 dark:bg-opacity-70 flex items-center justify-end pr-14 overflow-y-auto">
